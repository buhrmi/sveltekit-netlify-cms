...
This is the [`/routes/index.md`](https://github.com/buhrmi/sveltekit-netlify-cms/blob/main/src/routes/index.md) file, which is preprocessed by [mdsvex](https://mdsvex.com) and is [editable through Netlify CMS](https://sveltekit-netlify-cms.netlify.app/admin/#/).
